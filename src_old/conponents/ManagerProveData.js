    ...
    <Card.Body>
      ...
      <ol style={{ lineHeight: "45px", paddingLeft: "50px" }}>
        <li>
          ...
          <a href={certificate} target="_blank" rel="noreferrer" style={{color: "#90AACB" }}>法人登記書</a>&nbsp;
            <FontAwesomeIcon icon={faCloudDownload} />
          </span>
        </li>
        <li>
          <span style={{  color: "#90AACB",cursor: "pointer" }}>
            <a href={affidavit} target="_blank" rel="noreferrer" style={{color: "#90AACB" }}>切結書</a>&nbsp;
            <FontAwesomeIcon icon={faCloudDownload} />
          </span>
        </li>
        <li>
          <span style={{ color: "#90AACB", cursor: "pointer" }}>
          <a href={permit} target="_blank" rel="noreferrer" style={{color: "#90AACB" }}>政府勸募許可函</a>&nbsp;
