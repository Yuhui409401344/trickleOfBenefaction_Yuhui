    ...
    <div>
      ...
      <Container>
        ...
        <ProgressBar
          ...
          <Col style={{ zIndex: "2" }}>
            <FontAwesomeIcon
              style={{ color: "#26aa50", backgroundColor: "white", borderRadius: "100%", marginLeft: "80px" }}
              icon={faCircleCheck}
            />
            <br />
          ...
          <Col style={{ zIndex: "2" }}>
            <FontAwesomeIcon
              style={{  color: "#26aa50", backgroundColor: "white", borderRadius: "100%", marginLeft: "110px" }}
              icon={faCircleCheck}
            />
            <br />
          ...
          <Col style={{ zIndex: "2" }}>
            <FontAwesomeIcon
              style={{  color: "#26aa50", backgroundColor: "white", borderRadius: "100%", marginLeft: "140px" }}
              icon={faCircleCheck}
            />
            <br />
